...
# Bot information
API_ID = environ.get('API_ID', '24817837')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7902142337:AAHnPWS8wYpDqCpu5YprWJZ3d1QboG4-wbY')
if len(BOT_TOKEN) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002491166640 -1002143967853 -1002488233862 -1002241895434 -1002178700944 -1002450406603').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002376378205')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002276880389')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Ethan:Ethan123@telegrambots.lva9j.mongodb.net/?retryWrites=true&w=majority&appName=TELEGRAMBOTS")
...
# Bot settings
DELETE_TIME = int(environ.get('DELETE_TIME', 86400)) # Add time in seconds
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
MAX_BTN = int(environ.get('MAX_BTN', 20))
LANGUAGES = [language.lower() for language in environ.get('LANGUAGES', 'French vostfr japanese').split()]
...
INDEX_EXTENSIONS = [extensions.lower() for extensions in environ.get('INDEX_EXTENSIONS', 'mp4 mkv avi wmv mov').split()]
...
#premium info
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/fCZ.jpg')
